  ...
  return (
    <Section {...sectionData}>
      <div className="flex overflow-hidden flex-col md:flex-row items-center justify-center rounded-lg relative bg-white z-50 mb-[100px] md:mb-[220px] mt-4 w-full shadow-2xl drop-shadow-2xl">
        ...
        />
        <div className="p-5 flex items-start justify-start flex-col w-full">
          <h2 className="uppercase md:tracking-tight text-4xl lg:text-[64px] 2.5xl:text-[74px] leading-[60px] font-bold text-[#1A1A1A] mb-1">
            Your brand, your assets
          </h2>
          <p className="uppercase text-[#AAABAD] text-3xl md:mt-3 lg:text-[35px] 2.5xl:text-[40px] font-bold">
            any game, any platform, any medium
          </p>
          <p className="text-[1A1A1A] md:mt-3 lg:text-[16px] font-bold">
