...
const Contact = () => {
  ...
  return (
    <Section {...sectionData}>
      <div className='flex gap-18 flex-col lg:flex-row items-start justify-center relative z-50 mb-[100px]  mt-4 w-full'>
        <div className='flex-3 w-full bg-contact-bg bg-cover bg-top bg-right'>
            ...
            {hasBeenSubscribed ? (
              ...
              <>
                <input
                  ...
                  value={firstName}
                  onChange={(e) => handleFieldUpdate(e, setFirstName)}
                />
                <input
                  type='email'
                  placeholder='Email'
                  ...
                  value={email}
                  onChange={(e) => handleFieldUpdate(e, setEmail)}
                />
              </>
            )}
            <button
